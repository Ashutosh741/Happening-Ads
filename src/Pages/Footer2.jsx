                ...
                <Col md = '12'>
                    <div className="linkWrapper d-flex">
                            ...
                            <div className="rightContent">
                                ...
                                <div className="appStoreWrap d-flex gap-0">
                                    ...
                                    <div className="qrCode">
                                        <h6>Scan to get the link</h6>
                                        <div className="qrImage text-center gap-5">
                                        <img src = {qr} className='img-fluid w-100'/>
                                        </div>
                                    </div>
